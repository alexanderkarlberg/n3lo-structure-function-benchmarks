...
pdfs = np.loadtxt("StructureFunctions_N0LO.dat")
...
ax1.set_title(r"\textbf{LO {(LO evolution)}}", fontsize = 20)
...
ax1.set_title(r"\textbf{LO {(LO evolution), $\sqrt{s}=320$ GeV}", fontsize = 20)
...
plt.savefig("RedXSecNCp_N0LO.pdf")
plt.close()
...
plt.savefig("RedXSecNCm_N0LO.pdf")
plt.close()
...
plt.savefig("RedXSecCCp_N0LO.pdf")
plt.close()
...
plt.savefig("RedXSecCCm_N0LO.pdf")
plt.close()
