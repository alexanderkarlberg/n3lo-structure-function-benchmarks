...
pdfs = np.loadtxt("StructureFunctions_N3LO.dat")
...
ax1.set_title(r"\textbf{N$^3$LO {(NNLO evolution)}}", fontsize = 20)
...
ax1.set_title(r"\textbf{N$^3$LO (NNLO evolution), $\sqrt{s}=320$ GeV}", fontsize = 20)
...
plt.savefig("RedXSecNCp_N3LO.pdf")
plt.close()
...
plt.savefig("RedXSecNCm_N3LO.pdf")
plt.close()
...
plt.savefig("RedXSecCCp_N3LO.pdf")
plt.close()
...
plt.savefig("RedXSecCCm_N3LO.pdf")
plt.close()
